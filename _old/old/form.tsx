...
import { Section } from './section-form'
import {
  Sortable,
  SortableContent,
  SortableItem,
...
export function Form({ section }: { section: Section }) {
  ...
  const DeleteDialog = () => (
    <AlertDialog open={open} onOpenChange={setOpen}>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Delete section {section.title}?</AlertDialogTitle>
          <AlertDialogDescription>
            This action cannot be undone. This will permanently delete the
            section {section.title} from this entry.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
